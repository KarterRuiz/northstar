...
import type {
  ...
  TeacherHomeQuickAccessId,
} from "./load-teacher-home";

const ICONS: Record<TeacherHomeQuickAccessId, LucideIcon> = {
  classes: School,
...
export function TeacherQuickAccess({
  ...
  cards: TeacherHomeQuickAccessCard[];
}) {
  return (
    <section
      aria-labelledby="teacher-quick-access-heading"
      className="space-y-2.5"
    >
      <WorkspaceSectionHeader
        id="teacher-quick-access-heading"
        title="Quick Access"
      />
