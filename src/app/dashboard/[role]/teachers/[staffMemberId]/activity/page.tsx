...
/** Legacy Activity tab → Files & Activity */
export default async function StaffActivityRedirect({ params }: PageProps) {
  ...
  redirect(staffProfilePath(role, staffMemberId, "files-activity"));
}
