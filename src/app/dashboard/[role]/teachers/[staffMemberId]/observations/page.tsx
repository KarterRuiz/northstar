...
/** Legacy Observations tab → Professional Notes */
export default async function StaffObservationsRedirect({ params }: PageProps) {
  ...
  redirect(staffProfilePath(role, staffMemberId, "professional-notes"));
}
