...
import { StaffStudentRecordsTab } from "@/features/staff-profile/tabs/student-records-tab";
...
export default async function StaffStudentRecordsPage({ params }: PageProps) {
  ...
  return (
    <StaffStudentRecordsTab
      viewerRole={role}
      hasLinkedProfile={Boolean(profileLoad.member.profile_id)}
      transitionNotes={metrics.transitionNotes}
      transitionCompleted={metrics.transitionCompleted}
      transitionPendingReview={metrics.transitionPendingReview}
      reportCards={metrics.reportCards}
