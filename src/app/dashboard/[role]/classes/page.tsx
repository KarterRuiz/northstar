        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground max-w-2xl text-sm leading-relaxed">
              Create classes with{" "}
              <span className="text-foreground font-medium">+ New class</span>, then manage each
              class from its row actions. School years and grade levels are configured under{" "}
              <Link
